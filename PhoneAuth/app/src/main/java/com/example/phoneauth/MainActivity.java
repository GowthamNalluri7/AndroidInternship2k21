...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseAuth auth;
    /* To get otp, auto verification and to capture the failed cases */
    PhoneAuthProvider.OnVerificationStateChangedCallbacks callbacks;
    /* This tokes is used to resend the otp */
    PhoneAuthProvider.ForceResendingToken token;
    /* To store/hold the verification id */
    String id;
    @Override
    ...
    private void signPhoneAuth(PhoneAuthCredential phoneAuthCredential) {
        auth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
